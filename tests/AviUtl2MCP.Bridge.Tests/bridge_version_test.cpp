...
int main() {
    const std::array tests{
        ...
        std::pair{"bridge.batch-partial / native batch request handler",
            &test_native_batch_request_handler},
        std::pair{"bridge.handle-lifetime / native preview request handler",
            &test_native_preview_request_handler},
        ...
        std::pair{"bridge.gcmz-partial / native PSD create request handler",
            &test_native_psd_create_request_handler},
